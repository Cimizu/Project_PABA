...
class detail_resto : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_detail_resto, container, false)
        ...
        _btnLihatpaket.setOnClickListener {
            val restoranId = dataIntent?.namaResto // Or use a restaurant ID if available
            ...
            if (existingFragment == null) {
                parentFragmentManager.beginTransaction()
                    .replace(R.id.frameContainer, paketFragment, paket::class.java.simpleName) // Replace with the correct container ID
